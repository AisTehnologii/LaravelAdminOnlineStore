(function(jQuery) {
		...
		var isMobile = {
            ...
            if(!isMobile.any()){
                ...
                jQuery( window ).on('scroll',function(){
                    if((jQuery(this).scrollTop()>=jQuery('.main-menu').offset().top||jQuery('body').css('top').replace('px', '')<0)&&jQuery(this).scrollTop()!=0){
                        ...
                        jQuery('#main-menu-2.main-menu').css('background-color', '#363863');
                    }
                    else
                    {
                        ...
                        jQuery('#main-menu-2.main-menu').css('background-color', 'rgba(54, 56, 99, 0.58)');
                    }
                });
                // page refresh fix
            ...
            jQuery('#contact').submit(function() {
                ...
                if (errors == 0) {
                    ...
                    jQuery.ajax({
                        type: "POST",
                        url: 'contact.php', // ВАШ PHP ФАЙЛ ФОРМЫ ОБРАТНОЙ СВЯЗИ
                        data: formInput,
	...
	jQuery(window).load(function() {
                ...
                if(typeof google === 'object' && typeof google.maps === 'object'){
                    ...
                    jQuery(window).on('resize', function(){
                        map.setCenter({lat: 55.7472852, lng: 37.6215369});//coordinates where map is centered after you resize window
                    });
                    
                    var mapOptions = {
                        center: { lat: 55.7472852, lng: 37.6215369},//coordinates where map is centered
                        zoom: 14,
                        scrollwheel: false,
                    ...
                    var marker = new google.maps.Marker({
                        position: {lat: 55.747, lng: 37.621},
                        map: map,
                        icon: 'assets/img/marker.png',
                        title: '1'
                    });
                    google.maps.event.addListener(marker, 'click', function() {
                        infowindow.setContent("<strong>Название компании</strong><p>Описание компании</p>");
                        infowindow.open(map, this);
                    }); 
                    
                    var marker = new google.maps.Marker({
                        position: {lat: 55.749, lng: 37.621},
                        map: map,
                        icon: 'assets/img/marker.png',
                        title: '2'
                    });
                    ...
                    var marker = new google.maps.Marker({
                        position: {lat: 55.750, lng: 37.621},
                        map: map,
                        icon: 'assets/img/marker.png',
                        title: '3'
                    });
