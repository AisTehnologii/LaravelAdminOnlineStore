...
@php
  ...
  if (function_exists('filament')) {
      $isAdmin = filament()->auth()->check(); // <-- это самое надежное
  } else {
...
@endphp
  ...
  <style>
    ...
    .projects-viewall::after {
      content: none !important;
      display: none !important;
    }
    .projects-viewall .arrow {
      display: inline-flex;
      line-height: 1;
      transform: translateY(-1px);
    }

    /* ====== HERO CTA: одна кнопка, стабильная в RU/RO/EN ====== */
            ...
            <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
              <li class="active">
                <a href="#home-section" class="nav-link">
                  {!! $layoutHeader['menu_left_home'] ?? 'Home' !!}
                </a>
              </li>
              <li>
                <a href="#projects-section" class="nav-link">
                  {!! $layoutHeader['menu_left_projects'] ?? 'Projects' !!}
                </a>
              </li>
              <li>
                <a href="#services-section" class="nav-link">
                  {!! $layoutHeader['menu_left_services'] ?? 'Services' !!}
                </a>
              </li>
            </ul>
          </nav>
            ...
            <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
              <li>
                <a href="#about-section" class="nav-link">
                  {!! $layoutHeader['menu_right_about'] ?? 'About' !!}
                </a>
              </li>
              <li>
                <a href="#blog-section" class="nav-link">
                  {!! $layoutHeader['menu_right_blog'] ?? 'Blog' !!}
                </a>
              </li>
              <li>
                <a href="#contact-section" class="nav-link">
                  {!! $layoutHeader['menu_right_contact'] ?? 'Contact' !!}
                </a>
              </li>
        ...
        @foreach($banners as $banner)
          <div class="d-flex align-items-center" style="min-height: 400px;">
            <div>
              ...
              {{-- кнопку ИЗ слайдов убрали специально --}}
            </div>
          </div>
        @endforeach
      </div>
  ...
  <div class="site-section" id="services-section" data-editable>
    ...
    <div class="container">
      <div class="row mb-5 align-items-center">
        <div class="col-md-7">
          <h2 class="heading-39291 mb-0">
            {!! $homeSections['what_we_do_title'] ?? 'What We Do' !!}
          </h2>
        </div>
      </div>
  ...
  <div class="site-section" id="projects-section" data-editable>
    ...
    <div class="container">
      <div class="row mb-5 align-items-center">
        <div class="col-md-7">
          <h2 class="heading-39291 mb-0">
            {!! $homeSections['our_projects_title'] ?? 'Our Projects' !!}
          </h2>
        </div>
        ...
        <div class="col-md-5 text-right">
          <p class="mb-0">
            <a href="#projects-section" class="projects-viewall">
              <span class="more-39291__text">
                {!! $homeSections['our_projects_view_all'] ?? 'View All Projects' !!}
              </span>
  ...
  <div class="site-section" id="blog-section" data-editable>
    ...
    <div class="container">
      <div class="row mb-5">
        <div class="col-md-7">
          @if($blogTitle)
            <h2 class="heading-39291">{!! $blogTitle !!}</h2>
          @endif
    ...
    <div class="container">
      <div class="row">
          ...
          <div class="row">
            <div class="col-md-7">
              <h2 class="footer-heading mb-4">
                {!! $footerBlocks['about_title'] ?? 'About Us' !!}
              </h2>
              <p>
                {!! $footerBlocks['about_text']
            ...
            <div class="col-md-4 ml-auto">
              <h2 class="footer-heading mb-4">
                {!! $footerBlocks['features_title'] ?? 'Features' !!}
              </h2>

              <ul class="list-unstyled">
                <li>
                  <a href="#about-section">
                    {!! $footerBlocks['features_link_about'] ?? 'About Us' !!}
                  </a>
                </li>
                <li>
                  <a href="#testimonials-section">
                    {!! $footerBlocks['features_link_testimonials'] ?? 'Testimonials' !!}
                  </a>
                </li>

                {{-- Убрали ссылки: теперь это просто текст --}}
                ...
                <li>
                  <a href="#contact-section">
                    {!! $footerBlocks['features_link_contact'] ?? 'Contact Us' !!}
                  </a>
                </li>
              </ul>
            </div>
        ...
        <div class="col-md-4 ml-auto">
          <div class="mb-5">
            <h2 class="footer-heading mb-4">
              {!! $footerBlocks['newsletter_title'] ?? 'Subscribe to Newsletter' !!}
            </h2>
            ...
            <form action="#" method="post" class="footer-suscribe-form">
              ...
              <h2 class="footer-heading mb-4">
                {!! $footerBlocks['follow_us_title'] ?? 'Follow Us' !!}
              </h2>

              <a href="{{ $footerBlocks['social_facebook_url'] ?? '#about-section' }}" class="smoothscroll pl-0 pr-3"><span class="icon-facebook"></span></a>
